  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (context) => LoginProvider(apiService: ApiService())),
        ChangeNotifierProvider(create: (context) => RegisterProvider(apiService: ApiService())),
        ChangeNotifierProvider(create: (context) => AllStoriesProvider(apiService: ApiService())),
        ChangeNotifierProvider(create: (context) => DetailStoryProvider(apiService: ApiService())),
        ChangeNotifierProvider(create: (context) => UploadProvider(apiService: ApiService())),
      ],
